...
/* @galleries/view.twig */
class __TwigTemplate_0a4d4c2c16e7e1c2e8bf267fbaf981ec0f317617cd08d624845d29ca6e425818 extends Twig_SupTwgSgg_Template
{
    ...
    {
        // line 4
        echo "    <nav id=\"supsystic-breadcrumbs\" class=\"supsystic-breadcrumbs\" style=\"float: left; padding: 20px;\">";
        // line 7
        echo "        <a href=\"";
...
\t\t                    <i class=\"fa fa-fw fa-sort\"></i>";
        // line 28
        echo Twig_SupTwgSgg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Grid View")), "html", null, true);
        echo "
\t\t                </a>
\t\t            </li>
\t\t        </ul>
...
\t\t            <li id=\"checkedDoLi\" data-delete-confirm=\"";
        // line 59
        echo Twig_SupTwgSgg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Are you sure you want to delete photo from this gallery?")), "html", null, true);
        echo "\">
...
\t\t\t\t\t\t\t<option value=\"delete\">";
        // line 66
        echo Twig_SupTwgSgg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Delete selected")), "html", null, true);
        echo "</option>";
        // line 67
        if (($this->getAttribute(($context["environment"] ?? null), "isPro", array(), "method") == true)) {
            // line 68
            echo "\t\t\t\t\t\t\t\t<option value=\"new-category\">";
            echo Twig_SupTwgSgg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("New Category")), "html", null, true);
            echo "</option>
\t\t\t\t\t\t\t\t<option value=\"add-category\">";
            // line 69
            echo Twig_SupTwgSgg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Add Category")), "html", null, true);
            echo "</option>
\t\t\t\t\t\t\t\t<option value=\"del-category\">";
            // line 70
            echo Twig_SupTwgSgg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Delete Category")), "html", null, true);
            echo "</option>";
        }
        // line 72
        if (((($this->getAttribute(($context["environment"] ?? null), "isPro", array(), "method") == true) && $this->getAttribute(($context["settings"] ?? null), "attributes", array(), "any", true, true)) && (Twig_SupTwgSgg_length_filter($this->env, $this->getAttribute($this->getAttribute(($context["settings"] ?? null), "attributes", array()), "order", array())) > 0))) {
            // line 73
            echo "\t\t\t\t\t\t\t\t<optgroup label=\"Add Attributes\">";
            // line 74
            $context['_parent'] = $context;
            $context['_seq'] = Twig_SupTwgSgg_ensure_traversable($this->getAttribute($this->getAttribute(($context["settings"] ?? null), "attributes", array()), "order", array()));
            foreach ($context['_seq'] as $context["index"] => $context["name"]) {
                // line 75
                echo "\t\t\t\t\t\t\t\t\t\t<option data-attribute value=\"";
                echo Twig_SupTwgSgg_escape_filter($this->env, $context["index"], "html", null, true);
                echo "\">";
...
\t\t\t\t\t\t\t<select id=\"gg-attribute-values\" style=\"height: 34px; width: 150px;\" data-values=\"";
            // line 83
            echo Twig_SupTwgSgg_escape_filter($this->env, Twig_SupTwgSgg_jsonencode_filter($this->getAttribute(($context["gallery"] ?? null), "attributes", array())), "html", null, true);
            echo "\">
\t\t\t\t\t\t\t</select>
\t\t\t\t\t\t</li>
...
\t\t\t\t\t\t\t<select id=\"gg-categories-list\" style=\"height: 34px;\">";
            // line 91
            if ((Twig_SupTwgSgg_length_filter($this->env, $this->getAttribute(($context["gallery"] ?? null), "tags", array())) > 0)) {
                // line 92
                $context['_parent'] = $context;
...
\t\t\t\t\t\t\t<select id=\"gg-categories-del\" style=\"height: 34px;\">";
            ...
            if ((Twig_SupTwgSgg_length_filter($this->env, $this->getAttribute(($context["gallery"] ?? null), "tags", array())) > 0)) {
                ...
                echo Twig_SupTwgSgg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("All Categories")), "html", null, true);
                echo "</option>";
            }
            // line 106
            echo "\t\t\t\t\t\t\t</select>
...
\t\t\t\t\t\t<select id=\"gg-galleries-list\" style=\"height: 34px;\">";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["obj"]) {
            ...
            if (($this->getAttribute($context["obj"], "id", array()) != $this->getAttribute(($context["gallery"] ?? null), "id", array()))) {
                // line 113
                echo "\t\t\t\t\t\t\t\t\t<option value=\"";
                echo Twig_SupTwgSgg_escape_filter($this->env, $this->getAttribute($context["obj"], "id", array()), "html", null, true);
                echo "\">";
                echo Twig_SupTwgSgg_escape_filter($this->env, $this->getAttribute($context["obj"], "title", array()), "html", null, true);
                echo "</option>";
            }
        }
        $_parent = $context['_parent'];
...
\t\t\t\t\t\t<input id=\"find-by-caption\" type=\"text\" style=\"height:34px; width: 150px;\" placeholder=\"";
        // line 148
        echo Twig_SupTwgSgg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Search")), "html", null, true);
        echo "\">
\t\t\t\t\t</li>
...
\t\t\t\t\t<li>";
        // line 176
        if ((Twig_SupTwgSgg_length_filter($this->env, $this->getAttribute(($context["gallery"] ?? null), "photos", array())) > 0)) {
            // line 177
...
\t\t</div>
    ...
    <div id=\"linkedImagesDialog\" title=\"";
        ...
        // line 226
        echo Twig_SupTwgSgg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Remove selected")), "html", null, true);
        echo "</button>
        </div>
...
\t<div id=\"ggImageMetaDialog\" title=\"";
        // line 434
        echo Twig_SupTwgSgg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Meta Data")), "html", null, true);
        echo "\" style=\"display:none;\">
        ...
        if (($this->getAttribute(($context["environment"] ?? null), "isPro", array(), "method") == true)) {
            ...
            echo Twig_SupTwgSgg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Custom Attributes")), "html", null, true);
            echo "\" data-image-id=\"\" style=\"display:none;\">
        \t<div>
        \t\t<table>";
            // line 443
            if (($this->getAttribute(($context["settings"] ?? null), "attributes", array(), "any", true, true) && (Twig_SupTwgSgg_length_filter($this->env, $this->getAttribute($this->getAttribute(($context["settings"] ?? null), "attributes", array()), "order", array())) > 0))) {
                // line 444
                $context['_parent'] = $context;
                $context['_seq'] = Twig_SupTwgSgg_ensure_traversable($this->getAttribute($this->getAttribute(($context["settings"] ?? null), "attributes", array()), "order", array()));
                foreach ($context['_seq'] as $context["index"] => $context["name"]) {
...
\t   \t\t\t\t\t\t\t\t<input class=\"gg-attribute-new\" type=\"text\" data-attribute=\"";
                    ...
                    echo Twig_SupTwgSgg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("New value")), "html", null, true);
                    echo "\">
\t   \t\t\t\t\t\t\t</td>
\t   \t\t\t\t\t\t</tr>";
                }
                ...
                if (($this->getAttribute($this->getAttribute(($context["settings"] ?? null), "attributes", array()), "enabled", array()) != "false")) {
                    ...
                    echo "\t\t\t\t\t\t\t\t<td colspan=\"3\">";
                    // line 463
                    echo Twig_SupTwgSgg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No custom attributes have been specified for the gallery.")), "html", null, true);
                    echo "
\t\t\t\t\t\t\t\t</td>";
                } else {
                    // line 466
                    ...
                    // line 467
                    echo Twig_SupTwgSgg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("You need enable attribute in gallery settings.")), "html", null, true);
                    echo "
\t\t\t\t\t\t\t\t</td>";
                }
                // line 470
        ...
        \t\t\t\t\t<span style=\"font-weight: bold\">";
            // line 479
            echo Twig_SupTwgSgg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Button Link")), "html", null, true);
            echo "</span>
        \t\t\t\t</td>
        \t\t\t\t<td>
        \t\t\t\t\t<input id=\"ggButtonLinkUrl\" type=\"text\" style=\"height:30px; width: 100%;\" placeholder=\"";
            // line 482
            echo Twig_SupTwgSgg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Url")), "html", null, true);
            echo "\">
        \t\t\t\t</td>
        \t\t\t\t<td>
        ...
        \t\t\t\t\t<span style=\"font-weight: bold\">";
            // line 490
            echo Twig_SupTwgSgg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Keywords")), "html", null, true);
            echo "</span>
        \t\t\t\t</td>
        \t\t\t\t<td colspan=\"2\">
...
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t</figure>";
            } elseif (Twig_SupTwgSgg_in_filter(            // line 320
...
\t\t\t\t\t\t\t\t\t</figure>";
    ...
    {
        return new Twig_SupTwgSgg_Source("", "@galleries/view.twig", "/Users/Max/Local Sites/setina/app/public/wp-content/plugins/gallery-by-supsystic/src/GridGallery/Galleries/views/view.twig");
    }
}
