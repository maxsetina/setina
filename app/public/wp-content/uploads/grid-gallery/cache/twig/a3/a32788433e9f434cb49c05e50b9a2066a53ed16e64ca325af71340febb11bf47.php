...
class __TwigTemplate_9913c0fcfb82c0fe3510e6322030427856a7df9aeee454f080a740dcc8d28084 extends Twig_SupTwgSgg_Template
{
...
\t\t<label class=\"gg-pagination-per-page-lbl\">";
            // line 6
            echo Twig_SupTwgSgg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Show images per page")), "html", null, true);
            // line 7
...
\t\t<input type=\"hidden\" id=\"ggPaginationViewCurrPage\" value=\"";
            // line 15
            echo Twig_SupTwgSgg_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["settings"] ?? null), "info", array()), "currPageForJs", array()), "html", null, true);
            echo "\"/>
\t\t<input type=\"hidden\" id=\"ggPaginationViewTotal\" value=\"";
            // line 16
            echo Twig_SupTwgSgg_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["settings"] ?? null), "info", array()), "total", array()), "html", null, true);
            echo "\"/>
\t\t<div class=\"gg-links-list\" style=\"float:left;\">";
            ...
            if (($this->getAttribute($this->getAttribute(($context["settings"] ?? null), "info", array(), "any", false, true), "first", array(), "any", true, true) && $this->getAttribute($this->getAttribute(($context["settings"] ?? null), "info", array(), "any", false, true), "prev", array(), "any", true, true))) {
                ...
                echo Twig_SupTwgSgg_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["settings"] ?? null), "info", array()), "first", array()), "html", null, true);
                echo "\">";
                echo Twig_SupTwgSgg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("First")), "html", null, true);
                echo "</a>
\t\t\t\t<a class=\"gg-sett-pagination-link button\" href=\"";
                // line 20
                echo Twig_SupTwgSgg_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["settings"] ?? null), "info", array()), "prev", array()), "html", null, true);
                echo "\">";
                echo Twig_SupTwgSgg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Previous")), "html", null, true);
                echo "</a>";
            }
            // line 23
            $context['_parent'] = $context;
            $context['_seq'] = Twig_SupTwgSgg_ensure_traversable(($context["settings"] ?? null));
            foreach ($context['_seq'] as $context["ind1"] => $context["val1"]) {
                ...
                if (($context["ind1"] != "info")) {
                    ...
                    if (($this->getAttribute($this->getAttribute(($context["settings"] ?? null), "info", array()), "currentPage", array()) == $context["ind1"])) {
                        ...
                        echo Twig_SupTwgSgg_escape_filter($this->env, $context["ind1"], "html", null, true);
                        echo "</span>";
                    } else {
                        // line 28
                        echo "\t\t\t\t\t\t<a class=\"gg-sett-pagination-link button\" href=\"";
                        echo Twig_SupTwgSgg_escape_filter($this->env, $context["val1"], "html", null, true);
                        echo "\">";
                        echo Twig_SupTwgSgg_escape_filter($this->env, $context["ind1"], "html", null, true);
                        echo "</a>";
                    }
            ...
            if (($this->getAttribute($this->getAttribute(($context["settings"] ?? null), "info", array(), "any", false, true), "next", array(), "any", true, true) && $this->getAttribute($this->getAttribute(($context["settings"] ?? null), "info", array(), "any", false, true), "last", array(), "any", true, true))) {
                // line 35
                echo "\t\t\t\t<a class=\"gg-sett-pagination-link button\" href=\"";
                echo Twig_SupTwgSgg_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["settings"] ?? null), "info", array()), "next", array()), "html", null, true);
                echo "\">";
                echo Twig_SupTwgSgg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Next")), "html", null, true);
                echo "</a>
\t\t\t\t<a class=\"gg-sett-pagination-link button\" href=\"";
                // line 36
                echo Twig_SupTwgSgg_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["settings"] ?? null), "info", array()), "last", array()), "html", null, true);
                echo "\">";
                echo Twig_SupTwgSgg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Last")), "html", null, true);
                echo "</a>";
            }
            // line 38
            echo "\t\t</div>
\t</div>";
    ...
    {
        return new Twig_SupTwgSgg_Source("", "@galleries/helpers/pagination_view.twig", "/Users/Max/Local Sites/setina/app/public/wp-content/plugins/gallery-by-supsystic/src/GridGallery/Galleries/views/helpers/pagination_view.twig");
    }
}
